...
.header-nav {
    ...
    width: 100vw; /* 占满屏幕宽度 */
    z-index: 1000; /* 悬浮在最上层 */
    background: var(--bg-color); /* 背景色跟随主题 */
    color: var(--text-color); /* 文字色跟随主题 */
    backdrop-filter: blur(12px); /* 高斯模糊 */
    box-shadow: 0 10px 10px 0 rgba(0, 0, 0, 0.04); /* 阴影 */
}
...
.theme-switch {
    ...
    align-items: center; /* 垂直居中 */
    cursor: pointer; /* 鼠标手型 */
    color: var(--text-color-secondary); /* 次要文字色 */
    font-size: 1rem; /* 字号 */
    user-select: none; /* 禁止选中 */
...
@media (max-width: 900px) {
    ...
    .nav-menu {
        min-width: 180px; /* 菜单最小宽度变小 */
        margin: 0 8px; /* 左右间距变小 */
    }
    .site-name {
        font-size: 1rem; /* 网站名变小 */
    }
}
